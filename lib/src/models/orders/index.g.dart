...
class _$OrdersState extends OrdersState {
  @override
  final BuiltMap<String, Order> orders;

  factory _$OrdersState([void Function(OrdersStateBuilder)? updates]) =>
      (new OrdersStateBuilder()..update(updates)).build();

  _$OrdersState._({required this.orders}) : super._() {
    BuiltValueNullFieldError.checkNotNull(orders, 'OrdersState', 'orders');
  }
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is OrdersState && orders == other.orders;
  }

  @override
  int get hashCode {
    return $jf($jc(0, orders.hashCode));
  }

  @override
  String toString() {
    return (newBuiltValueToStringHelper('OrdersState')..add('orders', orders))
        .toString();
  }
}
...
class OrdersStateBuilder implements Builder<OrdersState, OrdersStateBuilder> {
  ...
  MapBuilder<String, Order>? _orders;
  MapBuilder<String, Order> get orders =>
      _$this._orders ??= new MapBuilder<String, Order>();
  set orders(MapBuilder<String, Order>? orders) => _$this._orders = orders;
  ...
  _$OrdersState build() {
    ...
    try {
      _$result = _$v ?? new _$OrdersState._(orders: orders.build());
    } catch (_) {
      late String _$failedField;
      try {
